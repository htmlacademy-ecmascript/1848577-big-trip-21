...
export default class PointsModel extends Observable {
  #service = null;
  #points = [];
  #managementPresenter = null;
  #destinationsModel = null;
  #offersModel = null;

  constructor({service, loadingPresenter, tripManagementPresenter, destinationsModel, offersModel}) {
    super();
    this.#service = service;
    this.loadingPresenter = loadingPresenter;
    this.#managementPresenter = tripManagementPresenter;
  ...
  async init() {
    try {
      ...
      this.#managementPresenter();
      this._notify(UpdateType.INIT);
    } catch(err) {
      this.#points = [];
      this.loadingPresenter.destroyComponent();
      this.loadingPresenter.init({isError: true});
    }
  }
